  ...
  else
  {
    return (
        <SafeAreaView style={{flex:1,paddingTop:Platform.OS==='android'?RFPercentage(5):0}}>
            <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",alignItems:"center",margin:RFPercentage(1)}}>
          ...
          <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} horizontal={false}>
                ...
                onPress={()=>navigation.navigate("inbox",{chatuser:item})}
                >
                    <Image
                    resizeMode='cover'
                    ...
                    <View>
                    <Text style={{color:colors.grey2,textAlign:"center",fontWeight:"200"}}>Contact</Text>
                    </View>
                </TouchableOpacity>
 ))
}
